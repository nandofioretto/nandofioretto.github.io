...
\subsectionTitle{Books}
\begin{pubs}
\labelc{Book:25}
\bf{[1]}	& \blink{}{\title{Differential Privacy in Artificial Intelligence: From Theory to Practice}}.~~~[\link{}{\footnotesize{\faLink}}] \\
		&  {\bf Ferdinando Fioretto} and Pascal Van Hentenryck. \\ 
	& Now Publisher, 2025 (forthcoming).\\[0.5em]
\end{pubs}
...
\confentryAwd
	...
	{~}
	{~39\%} % 3,682 of 11,500 
	{[Oral \& DARPA Disruptive Idea Award (includes a \$100,000 funding)]}{(5 \%)}
