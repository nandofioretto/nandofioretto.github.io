...
\begin{itemize}
	\item \nemph{Support for Scholarship awards to attend the 2025 AAAI Privacy Preserving AI workshop} \hfill\textsc{03/25}\\
	{\bf Sponsorship from:} 
	\textit{Deloitte} {(\$3000)};
	\textit{Google} {(\$5000)}; 
	\textit{Apple} {(\$3000)};
	...
	\item \nemph{Support for Scholarship awards to attend the 2024 AAAI Privacy Preserving AI workshop} \hfill\textsc{03/24}\\
	{\bf Sponsorship from:} 
	\textit{Google} {(\$5000)}; 
	\textit{OpenDP} {(\$500)}\\
	{\bf Role:} PI

	\item \nemph{Support for Scholarship awards to attend the 2023 AAAI Privacy Preserving AI workshop} \hfill\textsc{03/23}\\
	{\bf Sponsorship from:} 
	\textit{Google} {(\$2,500)}\\
	{\bf Role:} PI
\end{itemize}
