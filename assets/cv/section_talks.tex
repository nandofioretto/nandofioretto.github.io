...
\begin{itemize}
  \item {\bf Invited Talk}: The Principle of Data Minimization in Machine Learning\\
  {\em Google}
  \hfill{Forthcoming, 2024}

  \item {\bf Media Cover}: 
  {Building fairness into AI is crucial – and hard to get right}\\ 
  \press{https://theconversation.com/building-fairness-into-ai-is-crucial-and-hard-to-get-right-220271}{{\em The Conversation}}
  \hfill {Mar 2023}

  \item {\bf Invited Talk}: Responsible AI in Decision Making Processes\\
  {\em Amazon}
  \hfill{February 2024}
